    ...
    <div className="bg-white">
      ...
      <header className="p-4 bg-white">
        <div className="container mx-auto flex items-center justify-between">
          ...
          />
          <nav className="flex bg-black text-yellow-500 font-bold">
            <ul className="flex space-x-12 p-6">
              <li>
                <Link href="/">
                  <a className="hover:underline hover:bg-white hover:text-black">Home</a>
                </Link>
              </li>
              <li>
                <Link href="#">
              ...
              <li>
                <Link href="/about">
                  <a className="hover:underline hover:bg-white hover:text-black">About</a>
                </Link>
              </li>
              <li>
                <Link href="/contact">
                  <a className="hover:underline hover:bg-white hover:text-black">Contact</a>
                </Link>
              </li>
            </ul>
          </nav>
      ...
      <main className="flex-grow flex items-center justify-center p-6 text-yellow-500 bg-black">
        <div className="text-center max-w-lg">
          <h2 className="text-3xl font-bold mb-4 hover:bg-white hover:text-black">Welcome to Our Website</h2>
          <p className="mb-6">
            Discover high-quality fashion wear, services, and more. Let us guide you through a seamless experience.
          </p>
          <Link href="#">
            <a className="hover:underline hover:bg-white hover:text-black font-semibold">Learn More</a>
          </Link>
        </div>
      </main>
